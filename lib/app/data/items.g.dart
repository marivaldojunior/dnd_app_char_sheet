...
Item _itemDeserialize(
  ...
  final object = Item(
    description: reader.readStringOrNull(offsets[0]) ?? 'A simple sword.',
    name: reader.readStringOrNull(offsets[1]) ?? 'sword',
    price: reader.readStringOrNull(offsets[2]) ?? '0',
    quantity: reader.readLongOrNull(offsets[3]) ?? 1,
    type: reader.readStringOrNull(offsets[4]) ?? 'Props',
...
P _itemDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readStringOrNull(offset) ?? 'A simple sword.') as P;
    case 1:
      return (reader.readStringOrNull(offset) ?? 'sword') as P;
    case 2:
      return (reader.readStringOrNull(offset) ?? '0') as P;
    case 3:
      return (reader.readLongOrNull(offset) ?? 1) as P;
    case 4:
      return (reader.readStringOrNull(offset) ?? 'Props') as P;
    case 5:
